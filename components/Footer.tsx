        ...
        <div className="flex flex-col gap-5">
          <Link href="/">
            <div className="flex flex-row items-center gap-1">
              ...
              <span className="text-xl font-bold PoseidonFont">Reliant Services</span>
            </div>
          </Link>
          <div className="max-w-[550px] text-sm text-brandGray">
            {`Reliant Services is a Discord shop that sells high-quality Discord boosts, tools, and more. We offer a wide range of services to help you grow your community.`}
          </div>
          <div className="text-sm font-semibold brand_gradient text-transparent bg-clip-text text-brand">
            {`Reliant Services is not affiliated or endorsed by Discord in any way.`}
          </div>
      ...
      <div className="middle flex flex-row items-center justify-between px-4 pb-6 pt-2 xl:px-0">
        ...
        <Link href="https://discord.com/users/1305825677777309740" target="_blank">
          <div className="flex cursor-pointer flex-col rounded-md px-2 py-2">
            ...
            <div className="relative font-bold leading-[16px] text-[#9B4DCA]">
              <div className="absolute left-0 top-0 h-full w-full bg-[#9B4DCA] opacity-70 blur-lg" />
              <div className="relative z-10">{`Trey`}</div>
            </div>
          </div>
        </Link>
      </div>
